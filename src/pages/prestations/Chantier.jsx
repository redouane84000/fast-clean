      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-secondary/10 border border-secondary/20 mb-6">
            ...
            <span className="text-primary font-semibold">Nettoyage de Chantier</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Remise en état complète après travaux
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="card">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Notre service de nettoyage de chantier assure une remise en état 
                complète après vos travaux. Nous éliminons tous les déchets, 
                poussières et résidus de construction.
              </p>
              
              <p className="text-gray-600 leading-relaxed">
                De la démolition à la finition, nous garantissons un résultat 
                impeccable pour que vous puissiez profiter de votre espace rénové.
              </p>
            </div>
            ...
            <div className="card bg-gradient-to-br from-primary to-secondary text-white">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold">Inclus dans le service :</h4>
                  <ul className="space-y-2 text-sm opacity-90">
                    <li>• Évaluation de l'état du chantier</li>
                    <li>• Élimination des déchets</li>
                    <li>• Nettoyage des surfaces</li>
                    <li>• Remise en état des lieux</li>
        ...
        <div className="mt-16">
          <div className="w-full h-96 rounded-3xl overflow-hidden">
            <img 
              src="/image/nettoyage5.png" 
              alt="Nettoyage de chantier - Image supplémentaire" 
              className="w-full h-full object-cover"
            />
          </div>
        </div>
